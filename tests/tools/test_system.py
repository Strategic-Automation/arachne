...
def test_read_file_path_traversal():
    """Test path traversal mitigation for reading files."""
    result = read_file("../../../etc/passwd")
    assert "Access denied (path traversal" in result
...
def test_write_file_path_traversal():
    """Test path traversal mitigation for writing files."""
    result = write_local_file("../../../etc/passwd", "pwned")
    assert "Access denied (path traversal" in result
