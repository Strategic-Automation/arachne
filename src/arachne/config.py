...
def get_context_limit(model_name: str, llm_context_limit: int) -> tuple[int, str]:
...
def _cached_get_model_limits(
    ...
    ctx_limit, ctx_source = get_context_limit(model_name, llm_context_limit)
    limits = ModelLimits(
...
def get_model_limits(model_name: str, settings: Settings) -> Any:
    ...
    limits = _cached_get_model_limits(
        ...
        llm_context_limit=settings.llm_context_limit,
